...
//Manejador del TIMEOUT para envio de datos
...
void terminar(int signo) {
    ...
    printf("\nCliente terminado ordenadamente.");
    exit(0);
}
...
int main(int argc, char * argv[]) {
    ...
    //6.- Enviamos el nombre de fichero
        ...
        uint8_t longitud = strlen(argv[2]);
    ...
    */
    ...
    //8.- Enviamos todos los datos a golpe de temporizador
