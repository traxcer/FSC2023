/*
Basándose en los ejercicios 1 y 2, consiga la misma funcionalidad a 
...
por fifos. Uno de los programas es el que hace la lectura por teclado
y el envío a la fifo. El otro recibe por la fifo y muestra por pantalla. 
...
char mensaje[T];
    ...
    if ((fd=open("fifo", O_WRONLY))< 0){ //abro fifo escritura
        perror("open fifo");
        exit(1);
    }
do{
